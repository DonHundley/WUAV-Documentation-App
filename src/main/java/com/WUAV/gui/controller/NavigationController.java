...
public class NavigationController {
    ...
    public void setNavigationController() throws IOException {
        ...
        switch (access){
            case "ADMIN":
                Node a = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageTaskView.fxml"));
                viewAnchor.getChildren().setAll(a);
                home = "/com/WUAV/gui/view/ManageTaskView.fxml";
                break;
            case "MANAGER":
                Node m = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageTaskView.fxml"));
            ...
            case "TECHNICIAN":
                ...
                Node t = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageTaskView.fxml"));
                ...
                break;
            case "SALES":
                Node s = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageCustomersView.fxml"));
                viewAnchor.getChildren().setAll(s);
                home = "/com/WUAV/gui/view/ManageCustomersView.fxml";
                manageCustomerButton.setVisible(false);
                manageProjectsButton.setVisible(false);
                manageUserButton.setVisible(false);
                break;
    ...
    public void manageProjects(ActionEvent actionEvent) throws IOException {
        Node n = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageProjectView.fxml"));
        viewAnchor.getChildren().setAll(n);
    }

    public void manageCustomers(ActionEvent actionEvent) throws IOException {
        Node n = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageCustomersView.fxml"));
        viewAnchor.getChildren().setAll(n);
    }

    public void manageUsers(ActionEvent actionEvent) throws IOException {
        Node n = FXMLLoader.load(getClass().getResource("/com/WUAV/gui/view/ManageUsersView.fxml"));
        viewAnchor.getChildren().setAll(n);
    }
