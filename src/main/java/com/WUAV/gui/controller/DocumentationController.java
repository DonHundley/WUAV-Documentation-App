...
public class DocumentationController implements Initializable {
    ...
    private void newTask(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/WUAV/gui/view/NewTask.fxml"));
    ...
    private void editTask(){
        if (taskTV.getSelectionModel().getSelectedItem() != null){
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/WUAV/gui/view/EditTask.fxml"));
                Parent root = loader.load();
    ...
    @FXML private void addPictures(ActionEvent actionEvent){
        if(taskTV.getSelectionModel().getSelectedItem() != null) {
            try {
                messageLabel.setText("");
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/WUAV/gui/view/AddTaskPictures.fxml"));
                Parent root = loader.load();
                Stage stage = new Stage();
                Scene scene = new Scene(root);
    ...
    public void updateLayout(ActionEvent actionEvent) {
        if (taskTV.getSelectionModel().getSelectedItem() != null){
            try {
                messageLabel.setText("");
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/WUAV/gui/view/EditLayout.fxml"));
                Parent root = loader.load();
